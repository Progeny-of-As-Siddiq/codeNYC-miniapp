    ...
    <ScrollArea className="h-screen">
      <div className="min-h-screen bg-background pt-24 pb-12 px-4 sm:px-8 md:px-16 lg:px-48">
        <div className="max-w-3xl mx-auto space-y-12">
          {/* Title & Subtitle */}
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight">Documentation</h1>
          ...
          <div>
            ...
            <p className="mb-2 text-muted-foreground">Flyte AI has established direct integration partnerships with major global airlines, enabling real-time booking, inventory visibility, and seamless confirmations. Our partnerships include major carriers such as:</p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-muted-foreground">The team is <a href="mailto:team@flyteai.io" className="underline hover:text-foreground">team@flyteai.io</a></p>
            </div>
          </div>
        </div>
      </div>
